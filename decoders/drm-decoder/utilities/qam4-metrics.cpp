...
/* Distance to "1" */
                 outputMetrics [2 * i]. rTow1 =
	                        Minimum1 (real (signalVector [i]. signalValue),
	                                  rTableQAM4 [1][0],
	                                  signalVector [i]. rTrans);
	if (std::isnan (outputMetrics [2 * i]. rTow0))
	      outputMetrics [2 * i]. rTow0 = 0;
	if (std::isnan (outputMetrics [2 * i]. rTow1))
	      outputMetrics [2 * i]. rTow1 = 0;
...
/* Distance to "1" */
	         outputMetrics [2 * i + 1]. rTow1 =
	                        Minimum1 (imag (signalVector [i]. signalValue),
                                          rTableQAM4 [1][1],
	                                  signalVector [i]. rTrans);
	if (std::isnan (outputMetrics [2 * i + 1]. rTow0))
	      outputMetrics [2 * i + 1]. rTow0 = 0;
	if (std::isnan (outputMetrics [2 * i + 1]. rTow1))
	      outputMetrics [2 * i + 1]. rTow1 = 0;
	}
}
