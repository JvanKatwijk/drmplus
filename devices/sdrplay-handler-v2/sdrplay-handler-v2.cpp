...
int16_t	bank_rsp1 (int32_t freq) {
	...
	sdrplayHandler_v2::sdrplayHandler_v2  (QSettings *settings,
	                                       RadioInterface *mr,
	                                       int32_t	outputRate,
...
//      and be prepared for future changes in the settings
	...
	sdrplayHandler_v2::~sdrplayHandler_v2	(void) {
	stopReader ();
	sdrplaySettings -> beginGroup ("sdrplaySettings");
...
int32_t	sdrplayHandler_v2::getRate	(void) {
	return kHz (2112);
}
...
int32_t	sdrplayHandler_v2::getVFOFrequency	(void) {
...
bool	sdrplayHandler_v2::restartReader	(void) {
int	gRdBSystem;
int	samplesPerPacket;
mir_sdr_ErrT	err;
...
void	sdrplayHandler_v2::stopReader	(void) {
	if (!running. load ())
	   return;
...
void	sdrplayHandler_v2::resetBuffer	(void) {
	_I_Buffer	-> FlushRingBuffer ();
}

int16_t	sdrplayHandler_v2::bitDepth	(void) {
	return 12;
}

bool	sdrplayHandler_v2::loadFunctions	(void) {
...
void	sdrplayHandler_v2::report_dataAvailable (void) {
